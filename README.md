# Practice: "Battle Saga"

---

## About

Tasks from the practice.

Each task can reuse parts from the previous one. Or implement it from scratch.

Each task has a document with description and instructions.

Assertions are done with `pytest`.
